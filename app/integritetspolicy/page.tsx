      ...
      <div className="mx-auto max-w-3xl px-5 lg:px-8">
        ...
        <div className="mt-10 grid gap-8 text-sm leading-7 text-ink/72 dark:text-ivory/72">
          <section>
            ...
            <p className="mt-3">Örnflychts Förlag och Antikvariat är verksamhetsnamn inom Pensionat Granparken Aktiebolag, organisationsnummer 556378-2837, Drottning Kristinas väg 10, 761 40 Norrtälje. Kontakt: info@ornflychts.se.</p>
          </section>
          <section>
