...
export function Footer() {
  ...
  return (
    <footer className="border-t-2 border-brass/70 bg-ivory text-sm text-ink/70 dark:border-brass/40 dark:bg-black dark:text-ivory/68">
      <div className="mx-auto grid max-w-page gap-10 px-5 py-16 md:grid-cols-[1.3fr_1fr_1fr_1fr] lg:px-8">
        <div>
          <p className="font-serif text-3xl tracking-tight text-ink dark:text-ivory">
            Örnflychts Förlag
          </p>
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brass/90">Kundservice</p>
          <div className="mt-4 grid gap-3">
            <Link href="/kopvillkor" className="transition-colors duration-300 hover:text-forest dark:hover:text-brass">
              Köpvillkor
            </Link>
            <Link href="/angra-kop" className="transition-colors duration-300 hover:text-forest dark:hover:text-brass">
              Ångra köp
            </Link>
            <Link href="/integritetspolicy" className="transition-colors duration-300 hover:text-forest dark:hover:text-brass">
              Integritetspolicy
            </Link>
          </div>
        </div>
